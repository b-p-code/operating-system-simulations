// CS4760 2/18/23 Bryce Paubel Project 2 - updated for Project 4
...
typedef struct {
  ...
  unsigned long long int time_spent_in_system[2];
  unsigned long long int time_spent_running[2];
  int total_times_run;
...
//
// Input: PCB*, int, int
// The process table, the time spent running to add, and the pid of the process to update
//
// Output: void
